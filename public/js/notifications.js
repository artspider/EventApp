...
function confirmAction(toemit, key) {
  swal.fire({
    ...
    customClass: {
      ...
      confirmButton: "btn w-1/3 bg-lime-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-lime-700 active:bg-lime-900 focus:outline-none focus:border-lime-900 focus:ring ring-lime-300 disabled:opacity-25 transition ease-in-out duration-150 px-4 py-3 mr-4",
      cancelButton: "btn w-1/3 bg-rose-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-rose-700 active:bg-rose-900 focus:outline-none focus:border-rose-900 focus:ring ring-rose-300 disabled:opacity-25 transition ease-in-out duration-150 px-4 py-3"
    }
