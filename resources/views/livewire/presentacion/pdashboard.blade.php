<div>
    <div class="container h-full py-20 px-4 lg:px-0 lg:w-4/5 lg:mx-auto">
        <div class="grid-container 2xl:grid grid-cols-12 mx-auto">
            <div class="nextpresentations lg:w-4/5 col-span-6">
                <h2 class="text-2xl font-raleway font-semibold">
                    Próximas presentaciones
                </h2>
                @forelse ($presentaciones as $key => $presentacion)
                <a href="{{route('presentacion-checkin', $presentacion->id )}}">
                    <div class="card-next p-6 bg-white round-md shadow-lg border-r-4 border-r-purple-600 mt-6">
                        <div class="date-hour flex items-center">
                            <div
                                class="timer-wrapper w-14 h-14 bg-purple-600 rounded-md flex items-center justify-center">
                                <svg class="w-10 fill-current text-main-color" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path
                            ...
                            <div class="text-wrapper ml-4">
                                ...
                                <p class="time text-sm font-poppins font-light">{{$presentacion->hora}}</p>
                            </div>
                        </div>
            ...
            <div
                class="presentationdatacontainer col-span-6 lg:w-3/5 xl:w-1/2 2xl:w-full lg:grid grid-cols-2 gap-4 lg:mx-auto my-8">
                <!-- Crear Presentacion-->
                <div
                    ...
                    <a class="" href="{{ route('presentaciones-create') }}">
                        ...
                        <img class="w-48 md:w-40 lg:w-80 xl:w-56 mx-auto mt-2" src="{{url('/img/conference.png')}}"
                            alt="" />
